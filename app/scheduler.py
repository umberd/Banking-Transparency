...
def init_scheduler(app):
    ...
    # Register jobs here
    scheduler.add_job(
        id='refresh_all_accounts_daily', 
        func=refresh_all_accounts_job, 
        trigger='cron', 
        hour=3,  # Run at 3 AM UTC every day
        minute=0
    )
    
    scheduler.start()
    current_app.logger.info("Scheduler started with daily account refresh job at 03:00 UTC")

def refresh_all_accounts_job():
    """
